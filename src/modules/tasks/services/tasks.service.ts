...
export class TasksService {
    ...
    async findAll(user: ActiveUser, query: TaskQueryDto): Promise<PagePaginatedResponse<TaskEntity>> {
        const accessWhere = await this.abacService.buildTaskWhereOrThrow(
            user,
            'TASKS:READ',
        );
